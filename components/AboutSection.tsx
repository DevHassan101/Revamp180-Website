...
const highlights = [
  { icon: "tabler:map-pin",      text: "Based in Karachi — serving clients globally"    },
  { icon: "tabler:layout-grid",  text: "End-to-end digital solutions under one roof"    },
  { icon: "tabler:users",        text: "Dedicated team with deep domain expertise"       },
  { icon: "tabler:message-dots", text: "Agile workflow with transparent communication"  },
];
...
const servicePills = [
  ...
  "Social Media", "Video Editing", "App Design",
];
...
export default function AboutSection() {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(180deg, #000028 0%, #010045 40%, #01004C 70%, #000018 100%)",
      }}
    >
      {/* Glow orbs */}
      <div
        className="absolute left-[-80px] top-1/2 -translate-y-1/2 w-[480px] h-[480px] rounded-full blur-3xl pointer-events-none"
        style={{ background: "radial-gradient(circle, #1800C8 0%, transparent 70%)", opacity: 0.12 }}
      />
      <div
        className="absolute right-[-60px] bottom-0 w-[360px] h-[360px] rounded-full blur-3xl pointer-events-none"
        style={{ background: "radial-gradient(circle, #3520DC 0%, transparent 70%)", opacity: 0.1 }}
      />
      ...
      <div className="relative z-10 max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 xl:gap-20 items-center">
        ...
        >
          ...
          >
            ...
            <div
              ...
              style={{
                background: "linear-gradient(90deg, transparent 0%, #8B80FF 50%, transparent 100%)",
              }}
            />
            {/* Inner glow */}
            <div
              ...
              style={{
                background: "linear-gradient(180deg, rgba(139,128,255,0.08) 0%, transparent 100%)",
              }}
            />
          ...
          >
            <p className="text-white font-bold text-sm leading-tight">Award-Winning</p>
          ...
          >
            <div
              ...
              style={{
                background: "linear-gradient(135deg, rgba(139,128,255,0.18) 0%, rgba(53,32,220,0.12) 100%)",
            ...
            <Icon icon="tabler:arrow-right" className="w-4 h-4 ml-auto flex-shrink-0 text-[#8B80FF]" />
          </motion.div>
        </motion.div>
        ...
        <div>
          ...
          >
            ...
            <span className="text-[#C0BAFF] text-sm font-medium tracking-wide">Who We Are</span>
          </motion.div>
          ...
          >
            ...
            Karachi, Pakistan. We've helped 445+ businesses across multiple industries
            build powerful digital experiences that generate real, measurable results.
          </motion.p>
          ...
          >
            From brand identity to complex web applications — we handle everything
            under one roof, so you get a cohesive result without the coordination
            headache.
          </motion.p>
          ...
          >
            <Link
              href="/about"
              className="inline-flex items-center gap-2.5 px-6 py-3 rounded-full text-white font-semibold text-sm"
              style={{
                background: "linear-gradient(135deg, #1800C8 0%, #3520DC 100%)",
                boxShadow: "0 0 24px rgba(53,32,220,0.4)",
              }}
            >
              Meet the Team
            ...
            <Link
              ...
              style={{
                ...
                border: "1.5px solid rgba(139,128,255,0.32)",
